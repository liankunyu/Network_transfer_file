...
int main()
{
    ...
    {
        int a : 3; //第一个字节的0~2位
        int : 0;   //这里是说明的第二点，空域。空域不是从下一个字节，而是将4字节剩余的全部占了
    ...
    } data, *pData; //注意sizeof(data)=8，空域不是从下一个字节，而是将4字节剩余的全部占了
    ...
    data.d = 2;
    data.e = 4;
    printf("a = %d, b = %d, c = %d, d = %d, e = %d,sizeof(data)=%d\r\n",
           data.a, data.b, data.c, data.d, data.e, sizeof(data)); //结构体操作
